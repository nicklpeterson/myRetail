...
/**
 * The Authentication filter authenticates requests to the /login endpoint
 *
 * Users that wish to use the put /products/price/{id} endpoint must be authenticated
 * and send their JWT in a header on subsequent requests to the secure endpoint.
 */
@AllArgsConstructor
